...
export const createPlayList = async (req, res) => {
    try {
        ...
        //have to add validation if it exist or not and everything
...
export const addProblemToPlaylist = async (req, res) => {
    ...
    try {
        // Ensures problemIds is an array
        ...
        // Creating records for each problem in the playlist
...
export const removeProblemFromPlaylist = async (req, res) => {
  ...
  try {
    ...
    // It only delete given problemIds not all
